...
- The **link** sent to you (e.g. in a WhatsApp message from the planner).  
- The link opens a **single page** where you can see the job details and submit your quote.

---

## What you will see

When you open the link, the page shows:

1. **Job details**  
   - Booking reference  
   - **Pickup** – Address and date/time  
...
2. **Your identity (if the link was sent specifically to you)**  
   ...
   - This means the link was generated for you. In that case, you may also get **suggestions** for your trucks and drivers when you fill the form (see below).
...
- You will see a **success message** if the quote was submitted correctly.  
- The form may clear so you could submit again only if the planner has left the RFQ open for more quotes; normally one quote per vendor is enough.  
- The planner will see your quote on their RFQ Dashboard and may **accept** it and assign the job to you.
