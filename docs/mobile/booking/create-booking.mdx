...
- To change the address type, click <img src="/img/ic_change.svg" alt="change address type" width="20" height="20" style={{display: 'inline', verticalAlign: 'middle'}} /> located at the end of the text field
