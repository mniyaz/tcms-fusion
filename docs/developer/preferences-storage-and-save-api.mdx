---
sidebar_position: 3
title: Preferences Storage and Save API
---
...
![Persisted table preferences example](../transportation-cockpit/images/master-dashboard-columns-invoice-userid-enabled.png)

## Login preference load {#login-preference-load}
...
## Preference key strategy {#preference-key-strategy}
...
## Local preference read/write {#local-preference-readwrite}
...
## Backend save endpoint {#backend-save-endpoint}
...
## Master Dashboard saved fields {#master-dashboard-saved-fields}
