...
| `remarks` | string | Optional remarks or reason for the cancellation. |
...
curl -X POST "{BASE_URL}/rest/cancel/cancelBooking/user123/auth_key_xyz" \
  ...
  -d '{
    "bookingId": "BK001",
    "cancelValueList": { "amount": "0", "remarks": "Optional cancellation remarks" }
  }'
```
